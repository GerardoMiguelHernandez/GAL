...
<html lang="en">
 ...
 <script type="text/javascript">
  ...
  <script type="text/javascript">if($(window).width()>1024){document.write("<"+"script src='{{asset('katakilmt/js/jquery.preloader.js')}}></"+"script>");}  </script>
...
<header>
    ...
    <div class="row">
        ...
        <div class="navbar navbar_">
              <div class="container">
            <h1 class="brand brand_"><a href="index.html"><img alt="" src="kataklimt/img/logo.gif"> </a></h1>
...
<div class="bg-content">
    ...
    <div class="container">
        ...
        <article class="span6">
              <h3>Ultimas Imagenes</h3>
              <ul class="list-photo">
              @foreach($imagenes as $eventicos)
